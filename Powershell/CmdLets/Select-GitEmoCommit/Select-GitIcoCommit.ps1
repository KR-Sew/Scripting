function Select-GitIcoCommit {
    ...
    # Ensure valid branch selection
    if ($Branch -notin @("main", "dev")) {
        Write-Host "⚠️ Invalid branch '$Branch'. Defaulting to 'main'." -ForegroundColor Yellow
        $Branch = "main"
    }
