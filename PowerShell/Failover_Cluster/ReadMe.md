# <img src="../../Assets/icons8-cluster-64.png" width="45" alt="PowerShell"> Failover Cluster management
...
There is a collection of useful `PowerShell` scripts for managing and configuring **Failover and High Availability** cluster Role on **Windows Server**.  
