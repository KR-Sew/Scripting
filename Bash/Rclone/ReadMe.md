# <img src="../../Assets/rclone_logo_icon_168876.svg" width=35 alt="Bash Scripts Collection">  Installing the latest version of Rclone
...
- 📄[**Update `RClone`**](Update_rclone.sh)
  - Script for automatic update `RClone`
